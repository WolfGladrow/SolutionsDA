...
# png('NegativeBinomialVsLogNeg190723.png',width=16,height=16,units='cm',res=300)
plot(x,LN,type='l',lwd=3,col='blue',xlab='x',ylab='PDF, PD',las=0,cex=0.4,cex.lab=1.5)
points(xNB,NB,col='magenta',lwd=3,cex=0.4)
#dev.off()