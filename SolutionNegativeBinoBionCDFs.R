...
# png('BinoNegBinoCDFs220225.png',width=16,height=12,units='cm',res=300)
plot(na2,pbinom(na2,n,pb),type='l',lwd=1,col='blue',xlab='k or x',ylab='CDFs',las=1,cex=0.1)
lines(na2,pnbinom(na2,s,p),col='red',lwd=1,cex=0.1)
